...
class ExpectedCondition
{
    ...
    /**
     * A closure function to be executed by \Core\Web\Driver\Wait.
     *
     * @var callable
     */
    private $apply;
    ...
    /**
     * A closure function to be executed by WebDriverWait
     *
     * @return callable
     */
    ...
    public static function titleIs($title)
    {
        return new static(
            function ($driver) use ($title) {
                /** @var \Core\Web\DriverInterface $driver */
     ...
     *
     * @param \Core\Web\Driver\By $by
     * @return \Core\Web\Driver\ElementInterface
     */
    public static function presenceOfElementLocated(\Core\Web\Driver\By $by)
    {
        return new static(
     ...
     * @return \Core\Web\Driver\ElementInterface
     */
    public static function visibilityOfElementLocated(\Core\Web\Driver\By $by)
    {
        return new static(
            function ($driver) use ($by) {
                /** @var \Core\Web\DriverInterface $driver */
